...
const SamplePage = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      memo: "",
      id_customer: "",
      jenis_barang: jenisBrngPerusahaan,
      packing: "",
      asuransi: "",
      tgl_pickup: "",
      tgl_bongkar: "",
  ...
  const onSelectChange = (value, e) => {
    if (e.name === "id_customer") {
      ...
      // }
      formik.setFieldValue("id_albongkar", value[0].value);
      formik.setFieldValue("id_almuat", value[0].value);
